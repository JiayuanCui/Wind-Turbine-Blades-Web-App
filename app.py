...
mmap = folium.Map(location = [df1.latitude.mean(), df1.longitude.mean()], zoom_start=7, control_scale=True)
...
column2 = df1.loc[df1['p_name'] == option1]['case_id'].tolist()
option2 = st.selectbox(
    'Select a case ID',
    column2)  
df_selected2 = df_selected1.loc[df1.case_id == option2]
